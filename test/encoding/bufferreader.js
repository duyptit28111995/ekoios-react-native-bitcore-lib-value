...
describe('BufferReader', function() {
  ...
  describe('#readUInt64LEBN', function() {
    ...
    it('should return 10BIV', function() {
      var tenbiv = 10 * 1e8;
      var tenbivBuffer = Buffer.from('00ca9a3b00000000', 'hex');
      var br = new BufferReader(tenbivBuffer);
      br.readUInt64LEBN().toNumber().should.equal(tenbiv);
    });
